...
# ---------------------------------------------------------------------------
needs_types = [
    {"directive": "req",  "title": "Requirement",            "prefix": "REQ-",  "color": "#BFD8D2", "style": "node"},
    {"directive": "uc",   "title": "Usability Criterion",    "prefix": "UC-",   "color": "#DCB239", "style": "node"},
    {"directive": "spec", "title": "Specification",          "prefix": "SPEC-", "color": "#FEDCD2", "style": "node"},
    {"directive": "adr",  "title": "Architecture Decision",  "prefix": "ADR-",  "color": "#DF744A", "style": "node"},
    {"directive": "impl", "title": "Implementation",         "prefix": "IMPL-", "color": "#DCB239", "style": "node"},
